...
exports.map3 = exports.map2 = exports.map1 = exports.getMapData = void 0;
...
var composeMap = function composeMap(mapData) {
  ...
  if (mapData.center.isOverlay) {
    (0, _utilsMaps.showOverlay)(mapData);
  }
...
exports.showOverlay = exports.removeScroll = exports.removeActiveState = exports.addScroll = exports.addPlacemark = exports.addActiveState = void 0;
...
var showOverlay = function showOverlay(map) {
  var overlay = document.querySelector('.map__overlay');
  document.getElementById(map.center.id).addEventListener('wheel', function () {
    if (window.innerWidth > 1024) {
      overlay.style.display = 'flex';
    }
  });
  document.getElementById(map.center.id).addEventListener('mouseout', function () {
