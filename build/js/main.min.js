...
var _utilsMaps = require("./modules/maps/utils-maps");
var _initMaps = require("./modules/maps/init-maps");
var _initLoader = require("./modules/init-loader");
var _initIntroAnimation = require("./modules/init-intro-animation");
var _initSliderAnimation = require("./modules/init-slider-animation");
var _initParalaxAnimation = require("./modules/init-paralax-animation");
var _initShowBlockAnimation = require("./modules/init-show-block-animation");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  setTimeout(_initLoader.initLoader, 2000);
  // Инициализирует анимацию интро
  (0, _initIntroAnimation.initIntroAnimation)();
  // Инициализирует слайдера
  (0, _initSliderAnimation.initSliderAnimation)();
  (0, _initShowBlockAnimation.initShowBlockAnimation)();
  // Инициализирует анимацию паралакса
  (0, _initParalaxAnimation.initParalaxAnimation)();
  ...
  (0, _initMaps.getMapData)(_utilsMaps.map1);
  (0, _initMaps.getMapData)(_utilsMaps.map2);
  (0, _initMaps.getMapData)(_utilsMaps.map3);
  (0, _initMaps.getMapData)(_utilsMaps.map4);
...
},{"./modules/form-validate/form":3,"./modules/init-intro-animation":9,"./modules/init-loader":10,"./modules/init-menu":11,"./modules/init-paralax-animation":12,"./modules/init-show-block-animation":13,"./modules/init-slider-animation":14,"./modules/input-file/init-upload":19,"./modules/maps/init-maps":22,"./modules/maps/utils-maps":23,"./modules/modals/init-modals":24,"./modules/select/custom-select":27,"./utils/ios-vh-fix":30}],2:[function(require,module,exports){
"use strict";
...
exports.initIntroAnimation = void 0;
var _gsap = require("../vendor/gsap.min");
var _ScrollTriggerMin = require("../vendor/ScrollTrigger.min.js");
_gsap.gsap.registerPlugin(_ScrollTriggerMin.ScrollTrigger);
var initIntroAnimation = function initIntroAnimation() {
...
exports.initIntroAnimation = initIntroAnimation;

},{"../vendor/ScrollTrigger.min.js":33,"../vendor/gsap.min":34}],10:[function(require,module,exports){
"use strict";
...
exports.initParalaxAnimation = void 0;
var _gsap = require("../vendor/gsap.min");
var _ScrollTriggerMin = require("../vendor/ScrollTrigger.min.js");
_gsap.gsap.registerPlugin(_ScrollTriggerMin.ScrollTrigger);
var initParalaxAnimation = function initParalaxAnimation() {
  // Паралакс блоков вверх и вниз
  var paralaxBottom = document.querySelector('[data-paralax-direction="bottom"]');
  var paralaxTop = document.querySelector('[data-paralax-direction="top"]');
  if (paralaxBottom) {
    _gsap.gsap.to(paralaxBottom, {
      yPercent: 25,
      ease: 'none',
      scrollTrigger: {
  ...
  var paralaxScale = document.querySelectorAll('[data-paralax="scale"]');
  if (paralaxScale) {
    _ScrollTriggerMin.ScrollTrigger.batch(paralaxScale, {
...
exports.initParalaxAnimation = initParalaxAnimation;

},{"../vendor/ScrollTrigger.min.js":33,"../vendor/gsap.min":34}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initShowBlockAnimation = void 0;
var _gsap = require("../vendor/gsap.min");
var _ScrollTriggerMin = require("../vendor/ScrollTrigger.min.js");
_gsap.gsap.registerPlugin(_ScrollTriggerMin.ScrollTrigger);
var initShowBlockAnimation = function initShowBlockAnimation() {
  var animals = document.querySelectorAll('[data-animation] img');
  if (!animals) {
    return;
  }
  _ScrollTriggerMin.ScrollTrigger.batch(animals, {
    onEnter: function onEnter(batch) {
      _gsap.gsap.to(batch, {
        opacity: 1,
        scale: 1,
...
exports.initShowBlockAnimation = initShowBlockAnimation;

},{"../vendor/ScrollTrigger.min.js":33,"../vendor/gsap.min":34}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSliderAnimation = void 0;
var _gsap = require("../vendor/gsap.min");
var _ScrollTriggerMin = require("../vendor/ScrollTrigger.min.js");
_gsap.gsap.registerPlugin(_ScrollTriggerMin.ScrollTrigger);
var initSliderAnimation = function initSliderAnimation() {
  var slides = document.querySelectorAll('.slider__item');
  if (!slides) {
    return;
  }
  slides.forEach(function (slide, _i) {
    _ScrollTriggerMin.ScrollTrigger.create({
      trigger: slide,
      start: 'top top',
      pin: true,
...
exports.initSliderAnimation = initSliderAnimation;

},{"../vendor/ScrollTrigger.min.js":33,"../vendor/gsap.min":34}],15:[function(require,module,exports){
"use strict";
...
var _utilsMaps = require("./utils-maps");
// Получает данные из JSON файла и переносит их на карту
var getMapData = function getMapData(map) {
  if (!map) {
    return;
  }
  fetch(map.dataset.url).then(function (response) {
...
var composeMap = function composeMap(mapData) {
  var ymaps = window.ymaps;

  // Создает карту
  var map = new ymaps.Map(mapData.center.id, {
  ...
  if (mapData.center.img) {
    var baloon = new ymaps.Placemark(mapData.center.coordinates, {}, {
  ...
  var addPins = function addPins(pins) {
    ...
    for (var i = 0; i < pins.length; i++) {
      (0, _utilsMaps.addPlacemark)(pins[i], layout, placemarks);
    }
  ...
  if (mapData.map.hasClusterer) {
    (0, _utilsMaps.initClusterer)(mapData.pins, map);
  } else if (mapData.pins) {
    addPins(mapData.pins);
  }

  // Фильтрация пинов на карте
  var filterBtns = document.querySelectorAll('.filter__button');
  var filterPins = function filterPins() {
    filterBtns.forEach(function (button) {
      button.addEventListener('click', function () {
        // Меняет активное состояние кнопки
        (0, _utilsMaps.removeActiveState)(filterBtns);
        (0, _utilsMaps.addActiveState)(button);
        ...
        if (button.dataset.type === 'all') {
          ...
          for (var i = 0; i < mapData.pins.length; i++) {
            if (mapData.pins[i].type === button.dataset.type) {
              (0, _utilsMaps.addPlacemark)(mapData.pins[i], layout, placemarks);
            }
          }
        }
      });
  ...
  if (mapData.map.isOverlay) {
    (0, _utilsMaps.crtlZoom)(mapData, map);
  }

  // Убирает ресайз на десктопе (проверка размера начального экрана)
  var removeDesktopResize = function removeDesktopResize(mapName) {
    if (window.innerWidth > 1024) {
      (0, _utilsMaps.removeScroll)(mapName);
    } else {
      (0, _utilsMaps.addScroll)(mapName);
    }
  };
...
},{"./utils-maps":23}],23:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeScroll = exports.removeActiveState = exports.map4 = exports.map3 = exports.map2 = exports.map1 = exports.initClusterer = exports.crtlZoom = exports.addScroll = exports.addPlacemark = exports.addActiveState = void 0;
...
exports.map4 = map4;
var removeScroll = function removeScroll(mapName) {
...
var addScroll = function addScroll(mapName) {
...
var addPlacemark = function addPlacemark(pinData, layout, placemarks) {
  var ymaps = window.ymaps;
  var pin = new ymaps.Placemark(pinData.coordinates, {
    balloonContentHeader: pinData.title,
    balloonContentBody: pinData.description,
    balloonContentFooter: "\u0422\u0438\u043F \u0438\u043A\u043E\u043D\u043A\u0438: ".concat(pinData.type)
  }, {
...
var initClusterer = function initClusterer(pins, map) {
  var ymaps = window.ymaps;
  var clusterer = new ymaps.Clusterer({
    clusterDisableClickZoom: true
  });
  for (var i = 0; i < pins.length; i++) {
    var pin = new ymaps.Placemark(pins[i].coordinates, {
      balloonContentHeader: pins[i].title,
      balloonContentBody: pins[i].description,
      balloonContentFooter: "\u0422\u0438\u043F \u0438\u043A\u043E\u043D\u043A\u0438: ".concat(pins[i].type)
    }, {
      iconLayout: 'default#imageWithContent',
...
exports.initClusterer = initClusterer;
var removeActiveState = function removeActiveState(buttons) {
...
exports.removeActiveState = removeActiveState;
var addActiveState = function addActiveState(button) {
  button.classList.add('active');
};

// Дает скроллить при нажатом control
exports.addActiveState = addActiveState;
var crtlZoom = function crtlZoom(mapData, map) {
  var overlay = document.querySelector('.map__overlay');

  // Добавляет overlay при скролле (без нажатия control)
  document.getElementById(mapData.center.id).addEventListener('wheel', function () {
    if (window.innerWidth > 1024) {
...
},{"../../utils/focus-lock":28,"../../utils/scroll-lock":32}],26:[function(require,module,exports){
"use strict";
...
},{"../../utils/render":31,"./create-select-markup":26}],28:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":29}],31:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":29}],33:[function(require,module,exports){
"use strict";
