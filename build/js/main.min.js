...
window.addEventListener('DOMContentLoaded', function () {
  ...
  ymaps.ready((0, _initMaps.initMap)(_initMaps.mapData));
...
exports.mapData = exports.initMap = void 0;
...
var initMap = function initMap(data) {
  ...
  var baloon = new ymaps.Placemark(data.center, {}, {
  ...
  var addPin = function addPin(pinData) {
  ...
  var getPinData = function getPinData() {
    fetch('./../../../data/pins.json').then(function (response) {
